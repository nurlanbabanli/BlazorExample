...
namespace DataAccess.Configuration
{
    internal class OperationClaimEntityTypeConfiguration : IEntityTypeConfiguration<OperationClaim>
    {
        public void Configure(EntityTypeBuilder<OperationClaim> builder)
        {
            ...
            builder.Property(o => o.Id).HasColumnType("int").ValueGeneratedOnAdd().UseIdentityColumn(1, 1).IsRequired(true);
            builder.Property(o => o.Name).HasColumnType("nvarchar(50)").IsRequired(true);
